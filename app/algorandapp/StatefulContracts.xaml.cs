...
namespace algorandapp
{
    ...
    public partial class StatefulContracts : ContentPage
    {
        ...
        void StatefulExamples()
        {
            ...
            //string approvalProgramSourceRefactored = File.ReadAllText("V2/contract/stateful_approval_refact.teal");
            ...
            //string clearProgramSource = File.ReadAllText("V2/contract/stateful_clear.teal");
        ...
        public static string ExtractResourceText(String filename)
        {
